...
// Title: ADCLCD.c
//-----------------------------
// Purpose: Displays an ADC voltage or lux value from an input voltage (for lux, the input voltage depends on photoresistor voltage divider)
// Dependencies: none
// Compiler: MPLAB X IDE v6.20 - XC8 (v2.46)
// Author: Farid Farahmand and Joseph Walkup (im not sure what to put since most of the code is Farid's)
// Versions:
//  	V1.0: 4/30/24 
//-----------------------------
...
float voltage;
float lux;// hold the analog value (volt))
char data[10];
void ADC_Init(void);
